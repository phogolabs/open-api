# OpenAPI Generator for the golang-server library
...
The `GolangServerGenerator.java` has comments in it--lots of comments.  There is no good substitute
for reading the code more, though.  See how the `GolangServerGenerator` implements `CodegenConfig`.

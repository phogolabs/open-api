...
public class GolangServerGenerator extends DefaultCodegen implements CodegenConfig {
  ...
  public String getHelp() {
    return "Generates a golang-server client library.";
  }
  ...
  public GolangServerGenerator() {
    ...
    outputFolder = "generated-code/golang-server";
